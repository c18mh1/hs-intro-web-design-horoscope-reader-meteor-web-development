...
$('#submit').click(function(){
  ...
  alert("Capricorn -- Determination, Dominance, Persevering, Practical, Willful");
  //bonus
  $('#reading').append("Capricorn -- Determination, Dominance, Persevering, Practical, Willful");
} 
  ...
  alert("Sagittarius -- Philosophical, Motion, Experimentation, Optimism");
    //bonus
    $('#reading').append("Sagittarius -- Philosophical, Motion, Experimentation, Optimism");
